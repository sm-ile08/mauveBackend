      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr class="discount-row">
                <td colspan="3" style="padding: 8px; text-align: right;"><strong>20% Discount:</strong></td>
                <td style="padding: 8px;"><strong>-₦${parseFloat(
                  discount_amount,
                ).toLocaleString()}</strong></td>
              </tr>
          ...
          <div class="order-info" style="background-color: #fff3cd; border-left: 4px solid #ffc107;">
            ...
            <p><strong>Bank:</strong> Moniepoint<br>
            <strong>Account Number:</strong> 6470745840<br>
            <strong>Account Name:</strong> Fabiyi Oluwaferanmi Esther</p>
            <p><strong>Reference:</strong> ${order_code}</p>
            <p style="color: #856404;">After payment, your order will be processed within 24 hours.</p>
          </div>
          `
...
app.post("/api/orders", async (req, res) => {
  ...
  try {
    ...
    const discount_amount = products_total * 0.2;
    const discounted_products_total = products_total * 0.8;
    const total_amount = discounted_products_total + delivery_fee; // Delivery fee is added after discount
    const order_code = generateOrderCode();
...
app.post("/api/admin/orders/:orderCode/confirm-payment", async (req, res) => {
  ...
  try {
    ...
    const original_total = order.products_total / 0.8;
    const discount_amount = original_total - order.products_total;
